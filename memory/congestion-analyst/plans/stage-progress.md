...
**Updated**: 2026-06-21 (no stage transition; W3 initiation still blocked; 31st consecutive cycle with hub-pair LMP unavailable; evaluator W23 improvement plan deadline for item 0.10 was 2026-06-11 — OVERDUE by 20 days; 2026-06-22 flowday outlook: HOUSTON_IMPORT HIGH 40-58% (NL ramp HE18→HE21 +19,639 MW YE — series record, exceeds June 21 solstice +18,627 MW and June 18 record load day +17,935 MW; load peak 81,081 MW HE17; cap-out 11,326-12,550 MW sustained; Non-Spin DA ABSENT — right-tail 1.8x rule not applied, P90 lambda $75 unscaled); HOUSTON_SOUTH_MIDDAY_LOCAL MEDIUM 22-35% (cap-out 11,326-12,276 MW HE09-17; NL trough 22,778 MW HE10; dual-trigger active); WEST_TO_NORTH LOW 10-18% (GR_WEST HE23-24 = 12,027-12,272 MW; SCI 0.25-0.28; below June 17 series high of GR_WEST 16,805 MW / SCI 0.38); PANHANDLE NEGLIGIBLE 2-4% (GR_WEST HE01 = 17,575 MW, below ~15,000 MW binding threshold); Monday weekday — no weekend discount applied; all 7 source files PRODUCTION; hub-pair LMP ABSENT 31st cycle; self-review for June 21 solstice outlook (issued June 20) pending Tenaska T+2 ~2026-06-23)
